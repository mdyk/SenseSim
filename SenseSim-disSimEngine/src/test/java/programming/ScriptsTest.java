...
import sensesim.integration.mcop.NullMCopPluginFactory;
...
public class ScriptsTest {
    ...
    public void init() throws Exception{
        Injector injector = Guice.createInjector(new AbstractModule() {
            ...
            protected void configure() {
                ...
                bind(MCopPluginFactory.class).to(NullMCopPluginFactory.class);
    ...
    public void testScript() {
        File scriptFile = new File( getClass().getResource("/groovy/capabilititesSoldier.groovy").getFile());
